<img width="75px" height="75px" align="right" alt="create-structure-cli" src="https://raw.githubusercontent.com/SayantanCode/cli-project-structure-builder/refs/heads/dev/assets/create-structure-cli-logo.png" title="create-structure-cli"/>
